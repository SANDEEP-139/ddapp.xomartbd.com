@extends('layouts.app', ['activePage' => 'restaurants', 'activeButton' => 'restaurants', 'title' => 'restaurants', 'navName' => 'Create Restaurant'])
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0">{{ __('Create Restaurant') }}</h3>
                                </div>
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('restaurants.store') }}" enctype="multipart/form-data" id="restaurant-form">
                                @csrf
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="form-group{{ $errors->has('location') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="location" name="location" id="location" class="form-control{{ $errors->has('location') ? ' is-invalid' : '' }} location" placeholder="{{ __('Location') }}" value="{{ old('location') }}" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('restaurant_photos') ? ' has-danger' : '' }}">
                                        ...
                                        @include('alerts.feedback', ['field' => 'restaurant_photos'])
                                    </div>
                                    ...
                                    <div class="form-group{{ $errors->has('restaurant_tags') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="restaurant_tags" id="input-offer-price" class="form-control{{ $errors->has('restaurant_tags') ? ' is-invalid' : '' }}" placeholder="{{ __('Tags') }}" value="{{ old('restaurant_tags') }}" required autofocus data-role="tagsinput">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-default mt-4">{{ __('Create Restaurant') }}</button>
                                   </div>
                                </div>
                            </form>
                        </div>
