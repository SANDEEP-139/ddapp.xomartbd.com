                                ...
                                <h6 class="heading-small text-muted mb-4">{{ __('User information') }}</h6>
                                    ...
                                    <div class="pl-lg-4">
                                        ...
                                        <div class="form-group{{ $errors->has('mobile_number') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="mobile_number" name="mobile_number" id="input-mobile_number" class="form-control{{ $errors->has('mobile_number') ? ' is-invalid' : '' }}" placeholder="{{ __('Phone') }}" value="{{ old('mobile_number', $user->mobile_number) }}" required autofocus>

                                            @include('alerts.feedback', ['field' => 'mobile_number'])
                                        </div>
                                        <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                            <label class="form-control-label" for="input-email">{{ __('Email') }}</label>
                                            <input type="email" name="email" id="input-email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ __('Email') }}" value="{{ old('email', $user->email) }}" required autofocus>
                                        ...
                                        <div class="form-group{{ $errors->has('profile_pic') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="file" name="profile_pic" id="input-profile_pic" class="form-control{{ $errors->has('profile_pic') ? ' is-invalid' : '' }}" placeholder="{{ __('Profile Picture') }}" value="{{ old('profile_pic') }}"  autofocus>
                                            <img src=" {{$user->profile_pic }}" width="50" height="50">
                                            <input type="hidden" name="hidden_profile_pic" value="{{ $user->getRawOriginal('profile_pic') }}" />
                                        ...
                                        <div class="form-group{{ $errors->has('nid_number') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="nid_number" id="input-nid_number" class="form-control{{ $errors->has('nid_number') ? ' is-invalid' : '' }}" placeholder="{{ __('nid number') }}" value="{{ old('nid_number', $user->nid_number) }}" required autofocus>
                                        ...
                                        <div class="form-check form-check-radio">
                                            <label class="form-check-label">
                                                <input class="form-check-input" type="radio" name="gender" id="genders1" value="male" {{ $user->gender == 'male' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group{{ $errors->has('weather') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="weather" id="input-weather" class="form-control{{ $errors->has('weather') ? ' is-invalid' : '' }}" placeholder="{{ __('Weather') }}" value="{{ old('weather', $user->weather) }}" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('emergency_contact') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="emergency_contact" id="input-emergency_contact" class="form-control{{ $errors->has('emergency_contact') ? ' is-invalid' : '' }}" placeholder="{{ __('Emergency Contact') }}" value="{{ old('emergency_contact', $user->emergency_contact) }}" required autofocus>
                                    ...
                                    <div class="form-group">
                                        ...
                                        @foreach ($roles as $role_id => $role_name)
                                            <option value="{{$role_id}}" {{ $user->roles->contains($role_id) ? 'selected' : '' }}>{{ucfirst($role_name)}}</option>
                                        @endforeach
                                        </select>
